...
CItemUpgradeHelpWnd* CItemUpgradeHelpWnd::c_pThis = NULL;

CItemUpgradeHelpWnd::CItemUpgradeHelpWnd()
{
...
void CItemUpgradeHelpWnd::Remove()
{
	RemoveAllData();
	m_bActive	= FALSE;
	m_bInit		= FALSE;
...
void CItemUpgradeHelpWnd::RenderText()
{
	char szInfo[0xff] = {0,};
...
void CItemUpgradeHelpWnd::RenderTextEx()
{	
	if(m_bypage == 0)
	{
		for(BYTE i = 131; i <= 141; i++)
		{
...
void CItemUpgradeHelpWnd::SetOrder()
{	
}

void CItemUpgradeHelpWnd::SetActive(BOOL bActive)
{
	m_bActive	= bActive;
...
int CItemUpgradeHelpWnd::CheckInterface()
{
	m_bMouseIcon = FALSE;
...
void CItemUpgradeHelpWnd::SetButtonStatus(DWORD dwSprID, DWORD dwStatus)
{
	switch(dwStatus)
	{
	case 0://nomal
