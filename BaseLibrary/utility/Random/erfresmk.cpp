/**************************** ERFRESMK.CPP ******************** 2004-07-10 AF *
*
* This program makes a table of the residues of a certain expansion of the 
* error function, used for the Laplace method for calculating Wallenius 
* noncentral hypergeometric distribution.
*
* This program generates the file ERFRES.CPP. The program must be re-run if 
...
*
*
* © 2004 Agner Fog. GNU General Public License www.gnu.org/copyleft/gpl.html
*******************************************************************************/
...
int main() {
  ...
  FILE * f;                  // output file
  char filename[] = "erfres.cpp"; // name of output file

  if (sizeof(long double) < 10) {
    // Microsoft compiler does not support double precision.
    // Use Borland or Gnu compiler for best precision.
